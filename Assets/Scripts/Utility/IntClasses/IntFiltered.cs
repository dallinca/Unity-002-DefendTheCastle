...
public class IntFiltered {
    ...
    public IntFiltered(int baseInt) {
        this.baseInt = baseInt;
        filteredInt = baseInt;
        filterSequence.SetObserverFunction(UpdateFilteredInt);
    }
    ...
    /// <summary>
    /// <para>Sets the new base integer that the filters are applied to.</para>
    /// <para>Returns the new value of the filtered Integer.</para>
    /// </summary>
    /// <param name="newBaseInt"></param>
    /// <returns>The new value of the filtered Integer</returns>
    public int SetBaseInt(int newBaseInt) {
        baseInt = newBaseInt;
